...
#define MY_HASH_NUMBER USHRT_MAX
//USHRT_MAX
//519227
...
unsigned long mask=hashmask(16);
inline unsigned hashF0(const std::string& str)
{
    if(str.empty())
    {
...
inline unsigned hashF(const std::string& str)//http://en.wikipedia.org/wiki/Jenkins_hash_function
{
